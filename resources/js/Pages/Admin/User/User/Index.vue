                        ...
                        <table class="table mb-0" id="orderTable">
                            ...
                            <tbody>
                                <tr v-for="(user, index) in users.data" :key="index">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <Link :href="`/admin/users/${user.id}`" class="btn btn-success btn-space">Lihat Data</Link>
                                            <Link :href="`/admin/users/${user.id}/edit`" class="btn btn-warning btn-space">Edit</Link>
                                            <a href="#" @click.prevent="destroy(user.id)" class="btn btn-danger btn-space">Delete</a>
